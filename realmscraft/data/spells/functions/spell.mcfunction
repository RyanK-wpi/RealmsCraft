...
execute as @a[nbt=!{SelectedItem:{}}] unless entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick"}}] run replaceitem entity @s weapon.mainhand minecraft:carrot_on_a_stick{CustomModelData:1001,display:{Name:"\"Grab\""}}
