...
execute at @e[type=minecraft:armor_stand,name=missileMarker,scores={hasMissile=0}] positioned ~ ~-1 ~ run effect give @e[type=!#spells:undead,distance=..1.2] minecraft:instant_damage 1 0 true 
execute at @e[type=minecraft:armor_stand,name=missileMarker,scores={hasMissile=0}] positioned ~ ~-1 ~ run effect give @e[type=#spells:undead,distance=..1.2] minecraft:instant_health 1 1 true 
